...
public class QueuedCheckinsContentProvider extends ContentProvider {
  ...
  public static final Uri CONTENT_URI = Uri.parse("content://com.riverspart.provider.checkins/checkins");
  ...
  static {
   ...
   uriMatcher.addURI("com.riverspart.provider.checkins", "checkins", CHECKINS);
   uriMatcher.addURI("com.riverspart.provider.checkins", "checkins/*", CHECKIN_ID);
  }
  ...
  public String getType(Uri uri) {
    switch (uriMatcher.match(uri)) {
      case CHECKINS: return "vnd.android.cursor.dir/vnd.riverspart.checkin";
      case CHECKIN_ID: return "vnd.android.cursor.item/vnd.riverspart.checkin";
