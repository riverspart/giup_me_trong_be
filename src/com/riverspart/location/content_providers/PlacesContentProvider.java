...
public class PlacesContentProvider extends ContentProvider {
  ...
  public static final Uri CONTENT_URI = Uri.parse("content://com.riverspart.provider.places/places");
  ...
  static {
   ...
   uriMatcher.addURI("com.riverspart.provider.places", "places", PLACES);
   uriMatcher.addURI("com.riverspart.provider.places", "places/*", PLACE_ID);
  }
  ...
  public String getType(Uri uri) {
    switch (uriMatcher.match(uri)) {
      case PLACES: return "vnd.android.cursor.dir/vnd.riverspart.place";
      case PLACE_ID: return "vnd.android.cursor.item/vnd.riverspart.place";
