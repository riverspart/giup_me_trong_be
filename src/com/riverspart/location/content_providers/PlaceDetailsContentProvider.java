...
package com.riverspart.location.content_providers;
...
public class PlaceDetailsContentProvider extends ContentProvider {
  ...
  public static final Uri CONTENT_URI = Uri.parse("content://com.riverspart.provider.placedetails/places");
  ...
  static {
   ...
   uriMatcher.addURI("com.riverspart.provider.placedetails", "places", PLACES);
   uriMatcher.addURI("com.riverspart.provider.placedetails", "places/*", PLACE_ID);
  }
  ...
  public String getType(Uri uri) {
    switch (uriMatcher.match(uri)) {
      case PLACES: return "vnd.android.cursor.dir/vnd.riverspart.placedetail";
      case PLACE_ID: return "vnd.android.cursor.item/vnd.riverspart.placedetail";
